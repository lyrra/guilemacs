...
(ert-deftest cl-sort-test ()
  ...
  (let ((result (cl-sort (list "banana" "fig" "apple" "kiwi") (lambda (x y) (< (length x) (length y))) :key 'identity)))
  ...
  (let ((result (cl-sort (list 1 2 3 4 5) (lambda (x y) (> x y)))))
    (should (equal result '(5 4 3 2 1))))
  (let ((result (cl-sort '() '<)))
    (should (equal result '())))
  (let ((result (cl-sort (list "Banana" "apple" "cherry") 'string< :key 'downcase)))
    (should (equal result '("apple" "Banana" "cherry")))) )
...
(ert-deftest cl-stable-sort-test ()
  ...
  (let ((result (cl-stable-sort (list "banana" "apple" "cherry") 'string<)))
    (should (equal result '("apple" "banana" "cherry"))))
  (let ((result (cl-stable-sort (list "banana" "fig" "apple" "kiwi") (lambda (x y) (< (length x) (length y))) :key 'identity)))
    (should (equal result '("fig" "kiwi" "apple" "banana"))))
  ...
  (let ((result (cl-stable-sort (list -3 1 4 -1 -5 9) '<)))
    (should (equal result '(-5 -3 -1 1 4 9))))
  (let ((result (cl-stable-sort (list 1 2 3 4 5) (lambda (x y) (> x y)))))
    (should (equal result '(5 4 3 2 1))))
  (let ((result (cl-stable-sort '() '<)))
    (should (equal result '())))
  (let ((result (cl-stable-sort (list "Banana" "apple" "cherry") 'string< :key 'downcase)))
    (should (equal result '("apple" "Banana" "cherry")))) )
...
(ert-deftest cl-merge-test ()
  ...
  (let ((result (cl-merge 'list '() '() '<)))
    (should (equal result '())))
  (let ((result (cl-merge 'list (list 1 4 6) (list 2 3 5) '< :key (lambda (x) x))))
    (should (equal result '(1 2 3 4 5 6))))
  ...
  (let ((result (cl-merge 'list (list 1 2 3) (list 10 20 30) '< :key (lambda (x) (* x 10)))))
...
(ert-deftest cl-intersection-test ()
  ...
  ; FIX-20260321-guilemacs: "two" string has same identity
...
(ert-deftest cl-nintersection-test ()
  ...
  (let ((list1 (list 1 1 2 2 3))
        (list2 (list 2 2 3 4)))
    (let ((result (cl-nintersection list1 list2)))
      (should (equal result '(3 2 2)))
      (should (equal list1 '(1 1 2 2 3)))
      (should (equal list2 '(2 2 3 4)))))
  ; ditto, strings are eq in guilemacs
  ;(let ((list1 (list 1 "two" 3))
  ;      (list2 (list 3 "two" 4)))
  ;  (let ((result (cl-nintersection list1 list2)))
  ;    (should (equal result '(3)))

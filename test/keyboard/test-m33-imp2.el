;;; test-m33-imp2.el --- M33 imp-2 (xmenu.c/gtkutil.c menu/help consumers).
;;;
;;; Pins the M33 imp-2 port (brief.org): the decision logic of the X/GTK
;;; menu help and timer paths in src/xmenu.c and src/gtkutil.c moved
;;; into the new module (emacs menu), and the show_help_echo stub
;;; retired.
;;;
;;; Wraps test/keyboard/test-m33-imp2.scm -- the Scheme audit corpus.
...
(princ "=== m33 imp-2 (xmenu.c/gtkutil.c menu/help consumers) test suite ===\n")
...
(let* ((dir (file-name-directory (or load-file-name default-directory)))
       ...
       (corpus (expand-file-name "test-m33-imp2.scm" dir))
       (load-error nil))
      ...
      (let* ((name (car result))
        ...
        (cond
         (ok
          ...
          (eval `(ert-deftest ,(intern (format "m33-imp2/%s" name)) ()

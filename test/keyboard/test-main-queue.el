;;; test-main-queue.el --- M12 imp-3 test suite for the Scheme main-queue
;;; procedures ((emacs main-queue))
;;;
;;; Wraps test/keyboard/test-main-queue.scm — the Scheme test corpus for
;;; read-event-from-main-queue and read-decoded-event-from-main-queue
;;; (the ports of C read_event_from_main_queue / read_decoded_event_from
;;; _main_queue, src/keyboard.c:3140-3323).  See docs/m12-plan.org
;;; §imp-3 and brief.org.
;;;
...
(let* ((dir (file-name-directory (or load-file-name default-directory)))
       (corpus (expand-file-name "test-main-queue.scm" dir)))
  (eval-scheme

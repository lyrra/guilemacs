...
(defvar comint-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "M-r") 	  'comint-history-isearch-backward-regexp)
    ...
    (define-key map (kbd "M-C-l") 	  'comint-show-output)
    (define-key map (kbd "RET") 	  'comint-send-input)
    (define-key map (kbd "C-d") 	  'comint-delchar-or-maybe-eof)
    ...
    (define-key map (kbd "C-c SPC") 	  'comint-accumulate)
    (define-key map (kbd "C-c C-x") 	  'comint-get-next-from-history)
    (define-key map (kbd "C-c C-a") 	  'comint-bol-or-process-mark)
    (define-key map (kbd "C-c C-u") 	  'comint-kill-input)
    ...
    (define-key map (kbd "C-c C-\\")   'comint-quit-subjob)
    (define-key map (kbd "C-c C-m") 	  'comint-copy-old-input)
    (define-key map (kbd "C-c C-o") 	  'comint-delete-output)
    (define-key map (kbd "C-c M-o")    'comint-clear-buffer)
    (define-key map (kbd "C-c C-r") 	  'comint-show-output)
    (define-key map (kbd "C-c C-e") 	  'comint-show-maximum-output)
    (define-key map (kbd "C-c C-l") 	  'comint-dynamic-list-input-ring)
    (define-key map (kbd "C-c C-n") 	  'comint-next-prompt)
    (define-key map (kbd "C-c C-p") 	  'comint-previous-prompt)
    (define-key map (kbd "C-c C-d") 	  'comint-send-eof)
    (define-key map (kbd "C-c C-s") 	  'comint-write-output)
    (define-key map (kbd "C-c .") 	  'comint-insert-previous-argument)
    ;; Mouse Buttons:
...
(defun comint-dynamic-list-input-ring ()
  ...
  (if (or (not (ring-p comint-input-ring))
	...
	(let ((keymap (make-sparse-keymap)))
	  ...
	  (define-key keymap (kbd "RET") 'comint-dynamic-list-input-ring-select)

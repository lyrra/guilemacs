...
For an approximate inverse of this, see `key-description'."
  ...
  (cond ((string= keys "C-u") "\025")
        ...
        ((string= keys "C-o") "\017")
        ((string= keys "C-@") "\000")
        ((string= keys "C-SPC") "\000")
        ((string= keys "DEL") "\x7F")
        ((string= keys "C-z") "\032")
        ((string= keys "C-x C-z") "\030\032")
        ((string= keys "C-x C-k") "\030\013")
        ((string= keys "C-x (") "\030\050")
        ((string= keys "C-x )") "\030\051")
        ((string= keys "C-x e") "\030\005")
        ((string= keys "C-c C-c") "\003\003")
        ((string= keys "C-c ^") "\003\036")
        ((string= keys "C-v") "\026")
        ((string= keys "C-]") "\035")
        (t (key-parse keys))))
...
(defun internal--build-binding (binding prev-var)
  ...
  (setq binding
        (cond
         ...
         ((null (cdr binding))
          (list (intern-gensym "s") (car binding)))
         ((eq '_ (car binding))
          (list (intern-gensym "s") (cadr binding)))
         (t binding)))
...
of that nature."
  (declare (debug t) (indent 0))
  (let ((modified (intern-gensym "modified")))
...
If BODY finishes, `while-no-input' returns whatever value BODY produced."
  (declare (debug t) (indent 0))
  (let ((catch-sym (intern-gensym "input")))
    `(with-local-quit
       (catch ',catch-sym
...
The value returned is the value of the last form in BODY."
  (declare (indent 1) (debug t))
  (let ((old-case-table (intern-gensym "table"))
	(old-buffer (intern-gensym "buffer")))
...
Value is what BODY returns."
  (declare (debug t) (indent 1))
  (let ((old-table (intern-gensym "table"))
	(old-buffer (intern-gensym "buffer")))

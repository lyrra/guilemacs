...
argument replaces this)."
  ...
  (let ((buffer (intern-gensym "buffer"))
	(window (intern-gensym "window"))
...
to deactivate this overriding action."
  (let* ((old-window (or (minibuffer-selected-window) (selected-window)))
         ...
         (clearfun (intern-gensym "clear-display-buffer-overriding-action"))
         (postfun (intern-gensym "post-display-buffer-override-next-command"))

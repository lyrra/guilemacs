...
(defun prolog-mode-keybindings-common (map)
  ...
  (define-key map (kbd "C-c C-d") 'prolog-debug-on)
  (define-key map (kbd "C-c C-t") 'prolog-trace-on)
  (define-key map (kbd "C-c C-z") 'prolog-zip-on)
  (define-key map (kbd "C-c RET") 'run-prolog))

(defun prolog-mode-keybindings-edit (map)
  "Define keybindings for Prolog mode in MAP."
  (define-key map (kbd "M-a") 'prolog-beginning-of-clause)
  (define-key map (kbd "M-e") 'prolog-end-of-clause)
  (define-key map (kbd "M-q") 'prolog-fill-paragraph)
  (define-key map (kbd "C-c C-a") 'align)
  (define-key map (kbd "C-M-a") 'prolog-beginning-of-predicate)
  (define-key map (kbd "C-M-e") 'prolog-end-of-predicate)
  (define-key map (kbd "M-C-c") 'prolog-mark-clause)
  (define-key map (kbd "M-C-h") 'prolog-mark-predicate)
  (define-key map (kbd "C-c C-n") 'prolog-insert-predicate-template)
  (define-key map (kbd "C-c C-s") 'prolog-insert-predspec)
  (define-key map (kbd "M-RET") 'prolog-insert-next-clause)
  (define-key map (kbd "C-c C-v a") 'prolog-variables-to-anonymous)
  (define-key map (kbd "C-c C-v C-s") 'prolog-view-predspec)
  ...
  (if prolog-old-sicstus-keys-flag
      (progn
        (define-key map (kbd "C-c C-c") 'prolog-consult-predicate)
        (define-key map (kbd "C-c c") 'prolog-consult-region)
        (define-key map (kbd "C-c C") 'prolog-consult-buffer)
        (define-key map (kbd "C-c C-k") 'prolog-compile-predicate)
        (define-key map (kbd "C-c k") 'prolog-compile-region)
        (define-key map (kbd "C-c K") 'prolog-compile-buffer))

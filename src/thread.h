...
{
  eassert (THREADP (a));
  return SMOB_PTR3 (a, Lisp_Vectorlike, struct thread_state);
}
...
{
  eassert (MUTEXP (a));
  return SMOB_PTR3 (a, Lisp_Vectorlike, struct Lisp_Mutex);
}
...
{
  eassert (CONDVARP (a));
  return SMOB_PTR3 (a, Lisp_Vectorlike, struct Lisp_CondVar);
}

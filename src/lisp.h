...
#if LISP_WORDS_ARE_POINTERS
# define lisp_h_XLI(o) ((EMACS_INT) (SCM_UNPACK (o)))
# define lisp_h_XIL(i) ((Lisp_Object) (SCM_PACK (i)))
#else
...
/* Header of vector-like objects.  This documents the layout constraints on
   ...
   In guilemacs we have more than one member, so use struct.
  */
...
XBOOL_VECTOR (Lisp_Object a)
{
  ...
  return SMOB_PTR3 (a, Lisp_Vectorlike, struct Lisp_Bool_Vector);
}
...
XCHAR_TABLE (Lisp_Object a)
{
  ...
  return SMOB_PTR3 (a, Lisp_Vectorlike, struct Lisp_Char_Table);
}
...
XSUB_CHAR_TABLE (Lisp_Object a)
{
  ...
  return SMOB_PTR3 (a, Lisp_Vectorlike, struct Lisp_Sub_Char_Table);
}
...
{
  eassert (OBARRAYP (a));
  return SMOB_PTR3 (a, Lisp_Vectorlike, struct Lisp_Obarray);
}
...
XHASH_TABLE (Lisp_Object a)
{
  ...
  return SMOB_PTR3 (a, Lisp_Vectorlike, struct Lisp_Hash_Table);
}
...
#define DEFUNWRAP3(cfn, lfn) \
  Lisp_Object cfn (Lisp_Object a, Lisp_Object b, Lisp_Object c) \
  { \
    static Lisp_Object fn; \
    if (!fn) \
      { \
    ...
    return scm_call_3 (fn, a, b, c); \
  }

/* For functions with 0-1 optional arguments */
#define DEFUNWRAP_OPT1(cfn, lfn) \
  Lisp_Object cfn (Lisp_Object a) \
  { \
    static Lisp_Object fn; \
    if (!fn) \
...
extern Lisp_Object make_event_array_from_vector (Lisp_Object, ptrdiff_t, ptrdiff_t);
...
/* internal_lisp_condition_case removed - condition-case uses boot.el */
